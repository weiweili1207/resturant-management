...
public class JacksonObjectMapper extends ObjectMapper {
    ...
    public JacksonObjectMapper() {
        super();
        // Do not throw an exception for unknown properties
        ...
        // Register module functionalities, such as adding custom serializers and deserializers
